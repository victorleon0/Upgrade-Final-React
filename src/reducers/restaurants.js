...
const initialState = [
  ...
  },
  {
    ...
    subtitle:
      "El Eden es el terreno de juegos del chef Herman y el sumiller Robin. Su trocito de paraíso tiene un agradable toque vintage y respira calidez",
    price: 55,
  ...
  },
  {
    ...
    subtitle:
      "London Stock brings a relaxed, fine-dining concept to South London with a seasonal 8-course tasting menu. ",
    price: 40,
  ...
  switch (type) {
    ...
    case EDIT_RESTAURANT:
      return state.map((restaurant) =>
        restaurant.id === payload ? { ...restaurant, editing: !restaurant.editing } : restaurant
      );
